...
- **PWA (Progressive Web App)**: Можливість встановлення як окремого додатку на смартфон або ПК.
- **Media Session API**: Керування відтворенням прямо з екрану блокування системи або шторки сповіщень.
